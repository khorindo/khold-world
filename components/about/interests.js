    ...
    <div>
      <div className="bg-zinc-50 border border-black p-2.5 my-3 text-zinc-800 rounded-sm">
        ...
        <div className="mb-2 text-sm">
          i dont really like distilling stuff into charts but they get the point
          across i guess.
        </div>
        <Accordion type="single" collapsible>
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <div className="mb-2">
                ...
                and looking through my Discover Weekly all the time, and maybe I
                should get back to that lol
              </div>
              <div>
          ...
          <AccordionItem value="item-3">
            ...
            <AccordionContent>
              <div className="mb-2">
                The games I'm playing the most right now are (modern) Tetris and
                Melee. I play the Touhou games super very casually but I've
                grinded out a handful of normal 1ccs over the years. I also play
                rhythm games, most notably StepMania and osu! (i fw all the
                modes now actually)
              </div>
              <div className="mb-2">
